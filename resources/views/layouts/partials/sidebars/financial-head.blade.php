    ...
    <div class="px-4 py-6">
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('control-financial-check') }}"
               class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('control-financial-check') ? 'bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700' }}">
