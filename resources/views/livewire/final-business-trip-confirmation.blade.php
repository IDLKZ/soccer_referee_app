    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 animate-fade-in">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h1 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 flex items-center">
                        <i class="fas fa-clipboard-check mr-4"></i>
                        Финальная проверка командировок
                    </h1>
                    <p class="mt-2 text-base text-gray-600 dark:text-gray-400">
                        Окончательное согласование командировок судей перед регистрацией
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-pink-500 transform hover:scale-105 transition-transform duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                        ...
                        <div class="bg-pink-100 dark:bg-pink-900/30 p-4 rounded-full">
                            <i class="fas fa-hotel text-2xl text-pink-600 dark:text-pink-400"></i>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-gray-100 transition-all">
                </div>
            ...
            <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="flex flex-wrap gap-2">
                    <button wire:click="sortByField('created_at')"
                            class="inline-flex items-center px-4 py-2 rounded-lg text-sm transition-all {{ $sortBy === 'created_at' ? 'bg-purple-600 text-white shadow-lg' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600' }}">
                        Дата создания
                    ...
                    <button wire:click="sortByField('match_date')"
                            class="inline-flex items-center px-4 py-2 rounded-lg text-sm transition-all {{ $sortBy === 'match_date' ? 'bg-purple-600 text-white shadow-lg' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600' }}">
                        Дата матча
                    ...
                    <button wire:click="sortByField('referee')"
                            class="inline-flex items-center px-4 py-2 rounded-lg text-sm transition-all {{ $sortBy === 'referee' ? 'bg-purple-600 text-white shadow-lg' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600' }}">
                        Судья
                        @if($sortBy === 'referee')
                            <i class="fas fa-sort-{{ $sortDirection === 'asc' ? 'up' : 'down' }} ml-2"></i>
                        @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($trips as $index => $trip)
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 dark:border-gray-700 transform hover:-translate-y-2 animate-fade-in"
                        ...
                        <div class="bg-gradient-to-br from-purple-500 via-pink-500 to-red-600 p-5 text-white relative overflow-hidden">
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            <div class="flex items-center bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-700/50 dark:to-gray-700/30 rounded-lg p-3">
                                <div class="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center mr-3 shadow-lg">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2">
                                    <i class="fas fa-calendar-alt w-5 mr-2 text-purple-500"></i>
                            ...
                            <div class="flex items-center justify-around pt-3 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex flex-col items-center">
                                    <div class="bg-pink-100 dark:bg-pink-900/30 p-2 rounded-lg mb-1">
                                        <i class="fas fa-file-alt text-pink-600 dark:text-pink-400"></i>
                                    </div>
                        ...
                        <div class="px-5 pb-5">
                            <button wire:click="openDetailModal({{ $trip->id }})"
                                    class="w-full inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg transition-all shadow-md hover:shadow-xl transform hover:scale-105 font-semibold">
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-16 text-center border border-gray-200 dark:border-gray-700">
                ...
                @if($search || $filterLeague || $filterDateFrom || $filterDateTo)
                    <button wire:click="resetFilters"
                            class="inline-flex items-center px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors shadow-md">
                        <i class="fas fa-redo mr-2"></i>
                        Сбросить фильтры
                    </button>
                @endif
    ...
    @if($showDetailModal && $selectedTrip)
        <div class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden transform transition-all animate-scale-in"
                ...
                <div class="px-8 py-6 bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 text-white flex items-center justify-between relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full -mr-32 -mt-32"></div>
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold flex items-center">
                            <i class="fas fa-clipboard-check mr-3"></i>
                            Финальная проверка командировки
                        </h3>
                ...
                <div class="p-8 overflow-y-auto bg-gray-50 dark:bg-gray-900" style="max-height: calc(90vh - 250px);">
                    ...
                    <div class="mb-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                        <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center border-b border-gray-200 dark:border-gray-700 pb-3">
                            <div class="bg-purple-100 dark:bg-purple-900/30 p-2 rounded-lg mr-3">
                                <i class="fas fa-futbol text-purple-600 dark:text-purple-400"></i>
                            </div>
                            Информация о матче
                        </h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                ...
                                <p class="font-bold text-gray-900 dark:text-gray-100 mt-1">
                                    ...
                                    <span class="text-purple-500 mx-2">vs</span>
                                ...
                                @foreach($selectedTrip->trip_hotels as $tripHotel)
                                    <div class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-700/50 dark:to-gray-700/30 rounded-lg p-4 border-l-4 border-purple-500">
                                        <div class="font-bold text-gray-900 dark:text-gray-100 mb-2 flex items-center">
                                            <i class="fas fa-hotel mr-2 text-purple-500"></i>
                    ...
                    <div class="mb-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                        <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center border-b border-gray-200 dark:border-gray-700 pb-3">
                            <div class="bg-pink-100 dark:bg-pink-900/30 p-2 rounded-lg mr-3">
                                <i class="fas fa-file-alt text-pink-600 dark:text-pink-400"></i>
                            </div>
                        ...
                        @if($selectedTrip->trip_documents->count() > 0)
                            <div class="space-y-3">
                                @foreach($selectedTrip->trip_documents as $tripDocument)
                                    <div class="bg-gradient-to-r from-pink-50 to-rose-50 dark:from-gray-700/50 dark:to-gray-700/30 rounded-lg p-4 border-l-4 border-pink-500">
                                        <div class="font-bold text-gray-900 dark:text-gray-100 mb-2 flex items-center">
                                        ...
                                        <div class="grid grid-cols-3 gap-4 text-sm mb-2">
                                            <div class="bg-white dark:bg-gray-800 px-3 py-2 rounded-lg">
                                                ...
                                                <div class="font-bold text-purple-600 dark:text-purple-400">{{ number_format($tripDocument->price, 2) }} ₸</div>
                                            </div>
                                            <div class="bg-white dark:bg-gray-800 px-3 py-2 rounded-lg">
                                            ...
                                            <div class="bg-white dark:bg-gray-800 px-3 py-2 rounded-lg">
                                                ...
                                                <div class="font-bold text-pink-600 dark:text-pink-400">{{ number_format($tripDocument->total_price, 2) }} ₸</div>
                                            </div>
                                        </div>
                                        @if($tripDocument->file_url)
                                            <div class="text-xs">
                                                <a href="{{ asset('storage/' . $tripDocument->file_url) }}"
                                                   target="_blank"
                                                   class="inline-flex items-center text-purple-600 dark:text-purple-400 hover:underline bg-white dark:bg-gray-800 px-3 py-2 rounded-lg">
                    ...
                    <div class="mb-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                        <label class="block text-lg font-bold text-gray-900 dark:text-gray-100 mb-3 flex items-center">
                            ...
                            Комментарий финальной проверки
                        </label>
                        <textarea wire:model="final_comment"
                                  rows="4"
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-gray-100 transition-all"
                ...
                <div class="px-8 py-5 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border-t border-gray-200 dark:border-gray-600 flex justify-end gap-3">
                    ...
                    <button wire:click="acceptTrip"
                            wire:confirm="Вы уверены, что хотите принять эту командировку и отправить на регистрацию?"
