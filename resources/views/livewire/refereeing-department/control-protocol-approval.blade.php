    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                <i class="fas fa-shield-check text-green-600 dark:text-green-400 mr-3"></i>
                Финальная проверка протоколов
            </h1>
            <p class="text-gray-600 dark:text-gray-400">
                Окончательное утверждение протоколов от судей
            </p>
        </div>
        ...
        <div class="mb-6">
            <div class="relative">
                ...
                <input
                    ...
                    class="block w-full pl-12 pr-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                >
            </div>
        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="p-4 space-y-3">
                            ...
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-3 rounded-lg">
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-blue-800 dark:text-blue-300 font-medium">Прошел первичную проверку</span>
                                </div>
                                @if($protocol->primary_comment)
                                    <div class="mt-2 text-xs text-blue-700 dark:text-blue-300">
                                        <span class="font-semibold">Комментарий:</span> {{ Str::limit($protocol->primary_comment, 50) }}
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="flex items-center text-xs text-gray-500 dark:text-gray-400">
                                ...
                                Создан: {{ \Carbon\Carbon::parse($protocol->created_at)->format('d.m.Y H:i') }}
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-600">
                            <button
                                ...
                                class="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-2.5 px-4 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
                            >
        ...
        @else
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-12 text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400">
                    В данный момент нет протоколов, ожидающих финальной проверки
                </p>
            </div>
        @endif
    </div>
    ...
    @if($showDecisionModal && $selectedProtocol)
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" wire:click="closeDecisionModal">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto" wire:click.stop>
                <!-- Modal Header -->
                <div class="sticky top-0 bg-gradient-to-r from-green-600 to-emerald-600 text-white p-6 rounded-t-2xl z-10">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                            <i class="fas fa-futbol text-green-600 dark:text-green-400 mr-2"></i>
                            Информация о матче
                        </h3>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 rounded-xl p-6 border border-indigo-200 dark:border-indigo-800">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                            <i class="fas fa-clipboard-check text-indigo-600 dark:text-indigo-400 mr-2"></i>
                            Результат первичной проверки
                        </h3>
                        <div class="flex items-center mb-3">
                            <div class="flex items-center px-3 py-2 bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700 rounded-lg">
                                <i class="fas fa-check-circle text-green-600 dark:text-green-400 mr-2"></i>
                                <span class="text-green-800 dark:text-green-300 font-semibold">Одобрено</span>
                            </div>
                        </div>
                        @if($selectedProtocol->primary_comment)
                            <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-indigo-200 dark:border-indigo-700">
                                <label class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-2">Комментарий первичной проверки</label>
                                <p class="text-gray-900 dark:text-white whitespace-pre-wrap">{{ $selectedProtocol->primary_comment }}</p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 resize-none"
                        ></textarea>
