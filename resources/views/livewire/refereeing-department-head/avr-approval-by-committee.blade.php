    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 flex items-center">
                ...
                Проверка АВР судейским комитетом
            </h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Утверждение актов выполненных работ судейским комитетом
            </p>
        </div>
        ...
        <div class="space-y-4">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">
                АВР, ожидающие проверки комитетом
            </h2>
                ...
                <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                    ...
                    <div class="px-6 py-4 max-h-[70vh] overflow-y-auto">
                        ...
                        @if($selectedAvr->judge_comment)
                            <div class="mb-4">
                                <h4 class="text-md font-semibold text-gray-900 dark:text-gray-100 mb-3">Комментарий судьи</h4>
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Комментарий комитета {{ $confirmationAction === 'reject' ? '(обязательно)' : '(опционально)' }}
                            </label>
                            <textarea wire:model="control_comment" rows="4" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100" placeholder="{{ $confirmationAction === 'reject' ? 'Укажите причину отказа...' : 'Введите комментарий (опционально)...' }}"></textarea>
                            @error('control_comment')
                        ...
                        <div class="p-3 {{ $confirmationAction === 'accept' ? 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800' : 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800' }} border rounded-lg">
                            <p class="text-sm {{ $confirmationAction === 'accept' ? 'text-green-800 dark:text-green-400' : 'text-red-800 dark:text-red-400' }}">
                                @if($confirmationAction === 'accept')
                                    После утверждения АВР будет отправлен на первичную финансовую проверку.
                                @else
