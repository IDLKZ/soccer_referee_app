<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Управление странами</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Управление странами и их статусами</p>
        </div>
        @if($canCreate)
                        ...
                        <td class="px-4 py-4">
                            <div>
                                ...
                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                    {{ $country->title_kk }} / {{ $country->title_en }}
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <button wire:click="deleteCountry({{ $country->id }})"
                                        ...
                                        title="Удалить"
                                        onclick="return confirm('Вы уверены, что хотите удалить эту страну?')">
    ...
    <div class="text-center py-12">
        <div class="flex flex-col items-center">
            <i class="fas fa-globe text-4xl text-gray-300 dark:text-gray-600 mb-3"></i>
            <p class="text-gray-500 dark:text-gray-400 font-medium">Страны не найдены</p>
    ...
    <!-- Модальное окно создания страны -->
    @if($showCreateModal)
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full border border-gray-200 dark:border-gray-700">
                <form wire:submit.prevent="createCountry">
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="mb-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Создание новой страны</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Код страны*</label>
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full border border-gray-200 dark:border-gray-700">
                <form wire:submit.prevent="updateCountry">
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="mb-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Редактирование страны</h3>
                        </div>
